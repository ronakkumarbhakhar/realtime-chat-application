...
var notfriendsbtn = document.querySelector( "#notfriendsbtn" );
...
friendsbtn.addEventListener("click", ()=> {
    ...
    let d= document.querySelector('#notfriends')
    d.setAttribute("style", "display:None;");
    notfriendsbtn.classList.remove('active');
  ...
  notfriendsbtn.addEventListener("click", ()=> {
    ...
    notfriendsbtn.classList.remove('active');
    notfriendsbtn.classList.add('active');
...
clickHandler('.request','friends/request/','requested');
